--Thiết kế ERD và DDL (SQL Server) để lưu trữ thông tin về các seminar, buổi giảng phụ đạo của các thầy cô bên bộ môn SE. 
--Mỗi giảng viên có thể tổ chức nhiều seminar/buổi phụ đạo khác nhau và mỗi seminar/buổi phụ đạo chỉ do một giảng viên phụ trách  

--Thông tin lưu trữ bao gồm: mã số giảng viên, tên giảng viên, email, phone, bộ môn (SE, CF, ITS, Incubator), 
--ngày giờ seminar/phụ đạo, loại hình tổ chức (seminar, phụ đạo, workshop), chủ đề, tóm tắt nội dung, phòng học (nếu tiến hành offline), 
...
(
	LectID char(8),
	LectName nvarchar(30), --composite, tách nếu ta muốn sort theo last, first, middle,...
	Email varchar(50),
	Phone char(11),
	Major varchar(30),
 ...
 INSERT INTO ACTIVITY_V1 
    VALUES('00000001', N'HÒA.ĐNT', 'hoadnt@', '090x', 'CF', '2023-10-8', 'Seminar', 
 ...
 INSERT INTO ACTIVITY_V1 
    VALUES('00000001', N'HÒA.ĐNT', 'hoadnt@', '090x', 'CF', '2023-11-8 08:00:00', 'workshop', 
